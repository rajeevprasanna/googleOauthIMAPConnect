...
package com.googleMailOauth2Tools;
...
public class OAuth2Authenticator {
  ...
  public static final class OAuth2Provider extends Provider {
    ...
    public OAuth2Provider() {
      ...
      put("SaslClientFactory.XOAUTH2",
          "com.googleMailOauth2Tools.OAuth2SaslClientFactory");
    }
  }
   ...
   */
  public void connectIMAP(String oauthToken) throws Exception {
    /*if (args.length != 2) {
      System.err.println(
          "Usage: OAuth2Authenticator <email> <oauthToken>");
      return;
    }*/
    String email = "rajeevprasanna@gmail.com";
    //String oauthToken = "ya29.1.AADtN_UjjMHHynKBTCRgk2XMiKnEhc-qWFJAZVgmQEqhFHNTRJfZYJTKRvd5SA";

    initialize();
    oauthToken = "ya29.1.AADtN_VQ65xId5zpyEm2KcsAwlHwmylm434VIDUrL3SZP4FVb3snkuucHr_8MQ";
    ...
    javax.mail.Folder[] folders = imapStore.getDefaultFolder().list("*");
